...
_SYSTEM_PROMPT = (
    "당신은 가상 인격들이 한 이슈를 두고 벌인 광장 토론의 통계를 읽는 분석가다. "
    "이 수치들은 그 이슈의 여론이 어떻게 형성됐는지의 흔적이니, 단순 나열이 아니라 "
    "여론 형성(누가 의견을 주도했는지·어디로 쏠렸는지·무엇이 쟁점이었는지) 관점에서 해석하라. "
    ...
    "samples(게시물 본문)가 있으면 어떤 주장·쟁점·논조가 등장했는지 내용을 직접 짚어 "
    "여론의 방향을 읽어라. "
